...
CREATE TABLE gce_eligibility AS (
    WITH all_data AS (
        SELECT 
            ...
            case 
                when coalesce(nullif(r.uc2024, 0), nullif(r.uc2023, 0), nullif(r.uc2022, 0), nullif(r.uc2021, 0), nullif(r.uc2020, 0), nullif(r.uc2019, 0), 0) > unitsres
                then unitsres
            ...
            (   coalesce(nullif(r.uc2024, 0), nullif(r.uc2023, 0), nullif(r.uc2022, 0), nullif(r.uc2021, 0), nullif(r.uc2020, 0), nullif(r.uc2019, 0), 0) = 0
