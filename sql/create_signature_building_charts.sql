DROP TABLE IF EXISTS signature_building_charts2 CASCADE;
CREATE TABLE IF NOT EXISTS signature_building_charts2 AS
    ...
    hpdviolations AS (
        ...
        FROM hpd_violations
        INNER JOIN signature_unhp_data2 USING(bbl)
    ...
    rentstab_data as (
        ...
        INNER JOIN signature_unhp_data2 AS s ON r2.ucbbl = s.bbl
    ),
