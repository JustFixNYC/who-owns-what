...
rentstab as (
  select
    ...
    coalesce(uc2023, 0) rsunitslatest,
    coalesce(uc2023, 0) - coalesce(unitsstab2007, 0) rsdiff
  ...
  from 
    ...
    (
        select 
            ...
            as complainttype,
            count(*) filter (where receiveddate > CURRENT_DATE - '3 YEARS'::INTERVAL) as countrecentcomplaints,
