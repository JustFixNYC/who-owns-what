        ...
        <div className="PropertiesMap">
          ...
          */}
          ...
          <div className={`PropertiesMap__legend ${this.state.mobileLegendSlide ? 'PropertiesMap__legend--slide' : ''}`}
            ...
            <p><span>{Browser.isMobile() ? this.state.mobileLegendSlide ? <Trans>Close legend</Trans> : <Trans>View legend</Trans> : <Trans>Legend</Trans>}</span> <i>{this.state.mobileLegendSlide ? '\u2b07\uFE0E' : '\u2b06\uFE0E'}</i></p>
