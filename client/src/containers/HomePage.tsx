...
class HomePage extends Component<HomePageProps, State> {
  ...
  render() {
    ...
    const labelText = <Trans>Enter an NYC address and find other buildings your landlord might own:</Trans>;
        ...
        <div className="HomePage__content">
          <div className="HomePage__search">
            { this.state.searchAddress.housenumber ? (
              <Loader loading={true} ><Trans>Searching for <b>{this.state.searchAddress.housenumber} {this.state.searchAddress.streetname}, {this.state.searchAddress.boro}</b></Trans></Loader>
            ) : (
              <div>
          ...
          <div className="HomePage__samples">
            <h5 className="text-center"><Trans>... or view some sample portfolios:</Trans></h5>
              ...
              <div className="columns">
                <div className="column col-4 col-sm-12">
                  <div className="HomePage__sample">
                    ...
                    <Link className="btn block text-center" to={this.state.sampleURLs[0]} onClick={() => {window.gtag('event', 'example-portfolio-1-homepage');}} ><Trans>View portfolio</Trans> &#10230;</Link>
                  </div>
                </div>
                <div className="column col-4 col-sm-12">
                  <div className="HomePage__sample">
                    ...
                    <Link to={this.state.sampleURLs[1]} onClick={() => {window.gtag('event', 'example-portfolio-2-homepage');}} >
                      <img className="emassoc img-responsive" src={aeLogo} alt="A&amp;E Real Estate" />
                    </Link>
                    <Trans render="p">
                    ...
                    <Link className="btn block text-center" to={this.state.sampleURLs[1]} onClick={() => {window.gtag('event', 'example-portfolio-2-homepage');}} ><Trans>View portfolio</Trans> &#10230;</Link>
                  </div>
                </div>
                <div className="column col-4 col-sm-12">
                  <div className="HomePage__sample">
                    ...
                    <Link className="btn block text-center" to={this.state.sampleURLs[2]} onClick={() => {window.gtag('event', 'example-portfolio-3-homepage');}} ><Trans>View portfolio</Trans> &#10230;</Link>
                  </div>
                </div>
