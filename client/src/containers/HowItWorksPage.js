    ...
    <div className="HowItWorksPage Page">
      <div className="Page__content">
        ...
        <ul>
          ...
          <li><b>Eviction data for 2017 from <a href="mailto:housingdatacoalition@gmail.com" target="_blank">Housing Data Coalition</a>, via <a href="https://www1.nyc.gov/site/doi/offices/cpr2.page" target="_blank">NYC Marshals</a> <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank">(CC BY NC SA 4.0)</a>.
          </li>
