...
const indicatorHistorySQL = 
    ...
    ECB_VIOLATIONS AS (
      SELECT
          TO_CHAR(ISSUEDATE, 'YYYY-MM') AS MONTH,
          COUNT(*) FILTER (WHERE SEVERITY = 'Hazardous') AS ECB_VIOLATIONS_HAZARDOUS,
          COUNT(*) FILTER (WHERE SEVERITY = 'Non-Hazardous') AS ECB_VIOLATIONS_NONHAZARDOUS,
          COUNT(*) FILTER (WHERE SEVERITY = 'Unknown') AS ECB_VIOLATIONS_UNKNOWN,
  ...
  SELECT 
      ...
      COALESCE(ECB_VIOLATIONS_HAZARDOUS, 0) AS ECB_VIOLATIONS_HAZARDOUS,
      COALESCE(ECB_VIOLATIONS_NONHAZARDOUS, 0) AS ECB_VIOLATIONS_NONHAZARDOUS,
      COALESCE(ECB_VIOLATIONS_UNKNOWN, 0) AS ECB_VIOLATIONS_UNKNOWN,
