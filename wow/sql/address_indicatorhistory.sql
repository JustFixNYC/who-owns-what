WITH TIME_SERIES AS (
    ...
    REGULARDOBVIOLATIONS AS (
      SELECT
          ...
          COUNT(*) FILTER (WHERE VIOLATIONTYPECODE='EGNCY' OR VIOLATIONTYPECODE='IMEGNCY') REGULARDOBVIOLATIONS_EMERGENCY,
          COUNT(*) FILTER (WHERE VIOLATIONTYPECODE!= 'EGNCY' OR VIOLATIONTYPECODE != 'IMEGNCY') REGULARDOBVIOLATIONS_NONEMERGENCY,
  ...
  SELECT 
      ...
      COALESCE(REGULARDOBVIOLATIONS_EMERGENCY, 0) AS DOBVIOLATIONS_EMERGENCY,
      COALESCE(REGULARDOBVIOLATIONS_NONEMERGENCY, 0) AS DOBVIOLATIONS_NONEMERGENCY,
